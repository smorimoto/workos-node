/**
 * Options for removing a role assignment by role and resource criteria
 * Matches API: DELETE /authorization/organization_memberships/:om_id/role_assignments (with body)
 *
...
export interface RemoveRoleOptions {
  ...
  /** The role slug to remove (e.g., "editor", "viewer") */
  roleSlug: string;
...
/**
 * Serialized options for remove role API request (snake_case)
 */
